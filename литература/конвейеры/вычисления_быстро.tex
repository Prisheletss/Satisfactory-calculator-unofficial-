...
\subsection{Иные множества}

\

В завершение, давайте рассмотрим другое множество, например: $\mathbb{T} = \{ 3, 4, 7 \}$, но давайте не будем зарание пытаться что-то отделить, а просто нарисуем схему, и посмотрим, что она делает:
