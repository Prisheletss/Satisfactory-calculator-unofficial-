...
Работает это за счёт того, что мы поочерёдно реализуем небольшие степенные деревья, и предварительно успеваем их обрезать, предотвращая экспоненциальный взрыв. Таким образом, редуцировать размер можно до: 
