...
\noindent Он реализует следующее дерево поиска:
...
\begin{tikzpicture}[
	...
	\node[t]	(0-3)	at	(0, 3)	{27};
	\node[t]	(1-3)	at	(1, 3)	{54};
	\node[t]	(2-3)	at	(2, 3)	{108};
	
	\node[t]	(0-4)	at	(0, 4)	{81};
	\node[t]	(1-4)	at	(1, 4)	{162};
	
	\node[t]	(0-5)	at	(0, 5)	{243};
...
\noindent Нетрудно модифицировать данный алгоритм для произвольных $\mathbb{T}$, но не будем этим заниматься сдесь.
