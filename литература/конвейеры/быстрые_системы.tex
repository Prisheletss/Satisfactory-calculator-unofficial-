...
Также хочется отметить, что, поскольку каждая схема является графом -- то её можно описывать не в виде чертежа, а, например, в виде матрицы смежности для невзвешенного орграфа:
