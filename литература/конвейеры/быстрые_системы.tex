...
Рассмотрим квадратную субматрицу $M' \subset M$. Если рассмотреть её диагональное решение -- то  ячейки $m_{ij}$ характеризуют, во сколько раз различаются стоящие друг напротив друга входы и выходы. Есть несколько принципиальных значений:
