...
Также существуют специальные объекты, которые не являются ни соединителями ни разъединителями в прямом смысле: они либо имеют по два входа и выхода, либо, формально, не имеют ни одного, а просто ставятся между двумя конвейерами, и по некоторым правилам перекладывают ресурсы между ними (обычно, только в одном направлении):
...
\begin{minipage}{0.315\textwidth}
	\begin{tikzpicture}[
		s/.style={rectangle, draw=purple!100!blue!60, fill=purple!100!blue!5, ultra thick, minimum size=20},
		r/.style = {->, thin, rounded corners=10pt},
		]
		
		\draw[draw=purple!60!blue!10,	fill=purple!5!blue!5, ultra thick]	(-1, 0.333)	rectangle node {$\rightleftarrows$} (1, -0.333);
