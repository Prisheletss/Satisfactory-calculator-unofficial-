...
\footnote{Ресурсы равномерно распределяются между всеми выходами, обычно выполняется, как n-арное дерево}
...
\include{альтернативные системы.tex}
