...
\begin{tikzpicture}[
	...
	\node[o]	(outx)	at	(-6, 2)			{$x+q_1$};
	\node[o]	(outy)	at	(-6, -2)		{$y+q_2$};
	
	\node[o]	(inx)	at	(9.5, -2.55)	{$2x+q_1$};
	\node[o]	(iny)	at	(9.5, -9.35)	{$2y+q_2$};
	
	
	
	% === === Lines === ===
	\draw[r2]	(a1)		to	node[above]	{$x+y$}	(in);
	\draw[r`]	(a1)		to	(s1);
	...
	\draw[r`]	(ax)		to	node[above]	{$x$}	(sx);
	\draw[r`]	(ay)		to	node[above]	{$y$}	(sy);
